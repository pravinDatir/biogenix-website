...
@section('customer_content')
    ...
    >
        ...
        <script>
            ...
            // Also hook into the global modal-close if any
            document.querySelectorAll('[data-modal-close="addAddressModal"]').forEach(btn => {
                btn.onclick = () => toggleModal('addAddressModal', false);
            });
        </script>
    </x-account.workspace>
@endsection
