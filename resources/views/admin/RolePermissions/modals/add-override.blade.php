...
<div id="addOverrideModal" class="fixed inset-0 z-[9999] hidden" data-role-modal-root aria-hidden="true">
    ...
    <div class="fixed inset-0 flex items-center justify-center p-4 sm:p-6 pointer-events-none">
        <div class="pointer-events-auto relative w-full max-w-xl translate-y-4 scale-95 opacity-0 overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-[0_32px_96px_rgba(15,23,42,0.18)] transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] max-h-[94vh] flex flex-col" data-modal-dialog>
            ...
            <form method="POST" action="{{ route('admin.role-permission.overrides.store') }}" class="flex min-h-0 flex-1 flex-col font-sans">
                ...
                <div class="role-modal-scroll flex-1 p-5 space-y-5 overflow-y-auto">
                    <div class="space-y-4">
                        ...
                        <div class="relative">
                            <input type="text" data-role-modal-autofocus placeholder="Search by name, employee ID, or biometric tag..." value="Julian Vance" class="h-10 w-full rounded-xl border border-slate-200 bg-slate-50 pl-11 text-[12px] font-bold text-slate-800 outline-none focus:border-primary-600 transition">
                        ...
                        <div class="rounded-2xl border border-slate-100 bg-white p-4 shadow-sm flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <div class="h-9 w-9 rounded-2xl bg-primary-600 text-white flex items-center justify-center text-base font-bold font-display">JV</div>
                                <div>
                                    <h4 class="text-[13px] font-bold text-slate-900 leading-tight">Julian Vance</h4>
                                    <p class="text-[10px] text-slate-500 font-medium">Research Synthesis Associate • julian.v@biocobalt.io</p>
                                </div>
                            </div>
                    ...
                    <div class="p-4 rounded-2xl border border-slate-100 bg-slate-50/50 flex items-center justify-between">
                        <div>
                            <h4 class="text-[14px] font-bold text-slate-900 mb-0.5">Commit Policy Immediately</h4>
