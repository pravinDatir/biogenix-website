...
@section('admin_content')
    ...
    <div id="roleMainView" class="space-y-6 text-slate-900">
        <div>
            <h1 class="text-2xl font-extrabold text-[#0f172a] tracking-tight">Roles &amp; Permissions Center</h1>
        ...
        <div class="grid gap-6 xl:grid-cols-[minmax(0,2.3fr)_minmax(18rem,1fr)]">
            <section class="overflow-hidden rounded-[24px] border border-slate-200/80 bg-white shadow-[0_10px_28px_rgba(15,23,42,0.05)]">
                <div class="flex items-center justify-between gap-4 border-b border-slate-100 px-6 py-5">
                    ...
                    <a href="{{ route('adminPanel.role-permission.add-role') }}" class="ajax-link inline-flex items-center justify-center gap-2 rounded-xl bg-[#0b255e] px-4 py-3 text-[13px] font-extrabold text-white shadow-[0_10px_20px_rgba(11,37,94,0.18)] transition hover:brightness-105 cursor-pointer">
                            ...
                            @foreach ($systemRoles as $role)
                                <tr class="border-t border-slate-100">
                                    ...
                                    <td class="px-6 py-5 text-right">
                                        <button type="button" class="inline-flex h-8 w-8 items-center justify-center rounded-lg text-slate-400 transition hover:bg-slate-50 hover:text-[#102f72] cursor-pointer" aria-label="Edit {{ $role['name'] }}">
            ...
            <section class="overflow-hidden rounded-[24px] border border-slate-200/80 bg-white shadow-[0_10px_28px_rgba(15,23,42,0.05)]">
                ...
                <div class="space-y-3 p-4 sm:p-5">
                    ...
                    <a href="{{ route('adminPanel.role-permission.add-permission') }}" class="ajax-link inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#0b255e] px-4 py-3 text-[13px] font-extrabold text-white shadow-[0_10px_20px_rgba(11,37,94,0.18)] transition hover:brightness-105 cursor-pointer">
                        <svg class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                        </svg>
                        Add Permission
        ...
        <section class="overflow-hidden rounded-[24px] border border-slate-200/80 bg-white shadow-[0_10px_28px_rgba(15,23,42,0.05)]">
            ...
            <div class="flex justify-end px-4 py-4 sm:px-6">
                <button type="button" class="inline-flex items-center justify-center rounded-xl bg-[#0b255e] px-7 py-3 text-[14px] font-extrabold text-white shadow-[0_10px_20px_rgba(11,37,94,0.18)] transition hover:brightness-105 cursor-pointer">
                    Save Matrix Changes
                </button>
            </div>
        </section>
            ...
            <section class="overflow-hidden rounded-[24px] border border-slate-200/80 bg-white shadow-[0_10px_28px_rgba(15,23,42,0.05)]">
                ...
                <div class="space-y-5 p-6">
                    ...
                    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        ...
                        <a href="{{ route('adminPanel.role-permission.add-override') }}" class="ajax-link inline-flex items-center gap-1 text-[12px] font-extrabold uppercase tracking-[0.12em] text-emerald-600 cursor-pointer hover:text-emerald-700 transition">
                            <svg class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                            </svg>
                            Add
                ...
                <div class="space-y-4 p-6">
                    @foreach ($departments as $department)
                        <div class="flex items-center justify-between gap-4 rounded-2xl border border-slate-100 px-4 py-4">
                            ...
                            <button type="button" class="inline-flex h-8 w-8 items-center justify-center rounded-lg text-slate-400 transition hover:bg-slate-50 hover:text-slate-600 cursor-pointer">
                                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="{{ route('adminPanel.role-permission.assign-dept-role') }}" class="ajax-link flex min-h-[52px] w-full items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-white text-[15px] font-semibold text-slate-500 transition hover:border-slate-400 hover:text-slate-700 cursor-pointer">
            ...
            <div class="grid xl:grid-cols-2">
                <div class="space-y-5 p-6 xl:border-r xl:border-slate-100">
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <a href="{{ route('adminPanel.role-permission.add-delegation') }}" class="ajax-link inline-flex items-center gap-2 text-[13px] font-bold text-[#102f72] cursor-pointer hover:text-[#0b255e] transition">
                ...
                <div class="space-y-5 p-6">
                    ...
                    <a href="{{ route('adminPanel.role-permission.grant-impersonation') }}" class="ajax-link inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#0b255e] px-4 py-3 text-[14px] font-extrabold text-white shadow-[0_10px_20px_rgba(11,37,94,0.18)] transition hover:brightness-105 cursor-pointer">
