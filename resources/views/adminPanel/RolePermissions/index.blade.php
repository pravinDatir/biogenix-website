        ...
        <div class="grid gap-6 xl:grid-cols-[minmax(0,2.3fr)_minmax(18rem,1fr)]">
            <section class="overflow-hidden rounded-[24px] border border-slate-200/80 bg-white shadow-[0_10px_28px_rgba(15,23,42,0.05)]">
                <div class="flex items-center justify-between gap-4 border-b border-slate-100 px-6 py-5">
                    ...
                    <a href="{{ route('adminPanel.role-permission.add-role') }}" class="ajax-link inline-flex items-center justify-center gap-2 rounded-xl bg-primary-600 hover:bg-primary-700 px-4 py-3 text-[13px] font-extrabold text-white shadow-[0_10px_20px_rgba(6,81,237,0.18)] transition cursor-pointer">
            ...
            <section class="overflow-hidden rounded-[24px] border border-slate-200/80 bg-white shadow-[0_10px_28px_rgba(15,23,42,0.05)]">
                ...
                <div class="space-y-3 p-4 sm:p-5">
                    ...
                    <a href="{{ route('adminPanel.role-permission.add-permission') }}" class="ajax-link inline-flex w-full items-center justify-center gap-2 rounded-xl bg-primary-600 hover:bg-primary-700 px-4 py-3 text-[13px] font-extrabold text-white shadow-[0_10px_20px_rgba(6,81,237,0.18)] transition cursor-pointer">
                        <svg class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                        </svg>
                        Add Permission
            ...
            <section class="overflow-hidden rounded-[24px] border border-slate-200/80 bg-white shadow-[0_10px_28px_rgba(15,23,42,0.05)]">
                ...
                <div class="space-y-5 p-6">
                    ...
                    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        ...
                        <a href="{{ route('adminPanel.role-permission.add-override') }}" class="ajax-link inline-flex items-center gap-1 text-[12px] font-extrabold uppercase tracking-[0.12em] text-primary-600 cursor-pointer hover:text-primary-600 transition">
                            <svg class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                            </svg>
                            Add
            ...
            <div class="grid xl:grid-cols-2">
                <div class="space-y-5 p-6 xl:border-r xl:border-slate-100">
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <a href="{{ route('adminPanel.role-permission.add-delegation') }}" class="ajax-link inline-flex items-center gap-2 text-[13px] font-bold text-slate-600 cursor-pointer hover:text-slate-600 transition">
                ...
                <div class="space-y-5 p-6">
                    ...
                    <a href="{{ route('adminPanel.role-permission.grant-impersonation') }}" class="ajax-link inline-flex w-full items-center justify-center gap-2 rounded-xl bg-primary-600 hover:bg-primary-700 px-4 py-3 text-[14px] font-extrabold text-white shadow-[0_10px_20px_rgba(6,81,237,0.18)] transition cursor-pointer">
