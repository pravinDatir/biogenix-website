@php
    ...
    $states = [
        'success' => [
            ...
            'panel_class' => 'border-emerald-200 bg-emerald-50/80',
            'note_class' => 'border-emerald-200 bg-emerald-50/70',
        ...
        'retry' => [
            ...
            'panel_class' => 'border-amber-200 bg-amber-50/80',
            'note_class' => 'border-amber-200 bg-amber-50/70',
            'reference' => 'PAY-20260311-1058',
            'order_id' => $portal === 'b2b' ? 'ORD-20260311-2048' : 'ORD-20260311-1194',
