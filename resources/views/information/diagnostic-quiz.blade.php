...
@section('content')
                        ...
                        <div class="quiz-step active" data-step="1">
                            <section>
                                ...
                                <div class="flex items-center justify-between mt-6">
                                    <button type="button"
                                        class="inline-flex items-center gap-2 text-primary-800/60 font-bold text-sm tracking-wide transition hover:text-primary-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-600/20"
                                        onclick="prevStep()">
                                ...
                                <div class="relative z-10 w-full mb-4">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <input type="text" placeholder="Specify any specialized diagnostic niche..."
                                            class="{{ $quizFieldClasses }} xl:w-[70%]">
                                    </div>
                                ...
                                <div class="relative z-10 w-full mb-4">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8 lg:px-4">
                                        ...
                                        <div class="quiz-option group flex items-center justify-between min-h-[72px] rounded-[14px] border border-primary-100 bg-primary-50/40 px-6 py-4 cursor-pointer transition shadow-sm hover:border-primary-200 hover:bg-primary-50"
                                            ...
                                            <div data-option-icon
                                                class="w-6 h-6 rounded-[5px] border-2 border-primary-200 bg-white flex items-center justify-center transition-colors group-[.selected]:bg-secondary-100 group-[.selected]:border-secondary-100 ml-4 flex-shrink-0">
                                        ...
                                        <div class="quiz-option group flex items-center justify-between min-h-[72px] rounded-[14px] border border-primary-100 bg-primary-50/40 px-6 py-4 cursor-pointer transition hover:border-primary-200 hover:bg-primary-50 shadow-sm"
                                            ...
                                            <div data-option-icon
                                                class="w-6 h-6 rounded-[5px] border-2 border-primary-200 bg-white flex items-center justify-center transition-colors group-[.selected]:bg-secondary-100 group-[.selected]:border-secondary-100 ml-4 flex-shrink-0 shadow-sm group-[.selected]:shadow-none">
                                                <svg class="w-4 h-4 text-primary-900 opacity-0 group-[.selected]:opacity-100 transition-opacity"
                                                    fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="4">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        d="M5 13l4 4L19 7" />
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
                                        ...
                                        <div class="rounded-2xl border border-primary-100 bg-primary-50/40 p-6 md:p-8">
                                            ...
                                            <button type="button" id="quizSubmitButton"
                                                class="{{ $quizPrimaryButtonClasses }} w-full"
    ...
    <script>
        ...
        function submitLeadForm() {
            ...
            hideLeadError();
            [firstNameInput, lastNameInput, emailInput].forEach((input) => setFieldValidity(input, true));
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('#quizFirstName, #quizLastName, #quizEmail').forEach((input) => {
                input?.addEventListener('input', function () {
                    setFieldValidity(input, true);
                    hideLeadError();
                });
