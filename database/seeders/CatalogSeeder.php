...
class CatalogSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('product_variants')->insert([
            ['id' => 1, 'product_id' => 1, 'sku' => 'BIO-HEMA-X200-STD', 'variant_name' => 'Standard', 'technical_specification_json' => '{"Throughput":"60 tests/hour","Sample Volume":"20 uL","Display":"7-inch LCD"}', 'min_order_quantity' => 1, 'max_order_quantity' => 20, 'lot_size' => 1, 'model_number' => 'X200-STD', 'catalog_number' => 'CAT-HEMA-001', 'stock_quantity' => 8, 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 2, 'product_id' => 1, 'sku' => 'BIO-HEMA-X200-PRO', 'variant_name' => 'Pro', 'technical_specification_json' => '{"Throughput":"90 tests/hour","Sample Volume":"15 uL","Display":"10-inch LCD"}', 'min_order_quantity' => 1, 'max_order_quantity' => 20, 'lot_size' => 1, 'model_number' => 'X200-PRO', 'catalog_number' => 'CAT-HEMA-002', 'stock_quantity' => 4, 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 3, 'product_id' => 2, 'sku' => 'BIO-BIOC-B500-STD', 'variant_name' => 'Standard', 'technical_specification_json' => '{"Tests":"120 per hour","Cooling":"Yes","Connectivity":"LIS ready"}', 'min_order_quantity' => 1, 'max_order_quantity' => 12, 'lot_size' => 1, 'model_number' => 'B500-STD', 'catalog_number' => 'CAT-BIOC-001', 'stock_quantity' => 5, 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 4, 'product_id' => 3, 'sku' => 'BIO-DXR-1000-BASE', 'variant_name' => 'Base', 'technical_specification_json' => '{"Detector":"Flat panel","Resolution":"2048 x 2048 pixels","Power":"220V"}', 'min_order_quantity' => 1, 'max_order_quantity' => 6, 'lot_size' => 1, 'model_number' => 'DXR-1000', 'catalog_number' => 'CAT-DXR-001', 'stock_quantity' => 2, 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 5, 'product_id' => 4, 'sku' => 'BIO-USP-PRO-BASE', 'variant_name' => 'Base', 'technical_specification_json' => '{"Display":"15-inch touchscreen","Modes":"2D, Doppler, M-Mode","Power":"220V"}', 'min_order_quantity' => 1, 'max_order_quantity' => 8, 'lot_size' => 1, 'model_number' => 'USP-PRO', 'catalog_number' => 'CAT-USP-001', 'stock_quantity' => 3, 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 6, 'product_id' => 5, 'sku' => 'BIO-ECG-3000-BASE', 'variant_name' => 'Base', 'technical_specification_json' => '{"Leads":"12-lead","Display":"5-inch LCD","Battery":"Rechargeable"}', 'min_order_quantity' => 1, 'max_order_quantity' => 25, 'lot_size' => 1, 'model_number' => 'ECG-3000', 'catalog_number' => 'CAT-ECG-001', 'stock_quantity' => 12, 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 7, 'product_id' => 6, 'sku' => 'BIO-GLV-001-100', 'variant_name' => 'Pack 100', 'technical_specification_json' => '{"Material":"Nitrile","Powder Free":"Yes","Pack Size":"100 units"}', 'min_order_quantity' => 10, 'max_order_quantity' => 500, 'lot_size' => 10, 'model_number' => 'GLV-100', 'catalog_number' => 'CAT-GLV-001', 'stock_quantity' => 350, 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 8, 'product_id' => 7, 'sku' => 'BIO-SYR-050-50', 'variant_name' => 'Pack 50', 'technical_specification_json' => '{"Sterile":"Yes","Capacity":"5 ml","Pack Size":"50 units"}', 'min_order_quantity' => 10, 'max_order_quantity' => 500, 'lot_size' => 10, 'model_number' => 'SYR-050', 'catalog_number' => 'CAT-SYR-001', 'stock_quantity' => 500, 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
        ]);
        ...
        $genericPriceRows = [
            ['product_variant_id' => 1, 'price_type' => 'retail', 'company_id' => null, 'amount' => 265000.00, 'currency' => 'INR', 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
            ...
            ['product_variant_id' => 7, 'price_type' => 'public', 'company_id' => null, 'amount' => 120.00, 'currency' => 'INR', 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
            ...
            ['product_variant_id' => 8, 'price_type' => 'public', 'company_id' => null, 'amount' => 80.00, 'currency' => 'INR', 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
